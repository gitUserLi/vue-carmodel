<template>
	<div class='skudiv'>
		<div class='crumbs'>
			...
			<el-breadcrumb separator="/">
				<el-breadcrumb-item :to="{ path: '/' }"><b>SKU库</b></el-breadcrumb-item>
			</el-breadcrumb>
			<el-breadcrumb separator="/">
		...
		<div class='contDiv'>
			<div class="btndiv">
				<el-row>
					...
					<el-button plain class='pln'>上架</el-button>
					<el-button plain class='pln'>下架</el-button>
					<div class='subdiv'>
						<el-input
							placeholder="请输入内容"
